# -*- coding: utf-8 -*-
#
# angus.ai documentation build configuration file, created by
...
project = u'angus.ai'
copyright = u'2015-2018, Gwennael Gate, Aurelien Moreau'
...
texinfo_documents = [
  ('index', 'angusai', u'angus.ai Documentation',
   u'Gwennael Gate, Aurelien Moreau, Sylvain Girard', 'angusai', 'One line description of project.',
   'Miscellaneous'),
]
